...
| 0006 | [The site's look: rounded blues in Atkinson Hyperlegible, light and dark](0006-site-look-and-themes.md) | Colour role tokens with dark values; theme set before paint; panels glow, never outlined; pulse-W mark; the sheet keeps its look. |
