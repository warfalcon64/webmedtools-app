...
| 0006 | [The site's look: rounded blues in Atkinson Hyperlegible, light and dark](0006-site-look-and-themes.md) | Colours are role tokens with dark values; the theme is set before paint; the printed sheet keeps its own look. |
